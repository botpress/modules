...
export default class CreateModal extends React.Component {
  ...
  renderNextOccurences() {
    ...
    if (this.state.expressionType === '1') { // CRON
    ...
    return <div className={style.callout}>
      {occurences.map((o, i) => <Label key={i}>
        {moment(o).format('lll')}
      </Label>)}
    </div>
  }
  ...
  render() {
    ...
    return <Modal show={this.state.show} onHide={::this.close} backdrop="static">
      ...
      <Modal.Footer>
        ...
        <Button onClick={::this.create} bsStyle="primary">Schedule</Button>
      </Modal.Footer>
    </Modal>
  }
}
