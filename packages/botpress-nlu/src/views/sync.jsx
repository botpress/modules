      ...
      <Modal show={this.props.show} bsSize="small" animation={false}>
        ...
        <Modal.Body>
          ...
          {this.state.isSyncing &&
            <p className={style.loading}>Syncing</p>
          }
          {this.state.syncFailedError &&
            <p>Syncing failed, reason : {this.state.syncFailedError}</p>
          }
        </Modal.Body>

        <Modal.Footer>
          <Button disabled={this.state.isSyncing} onClick={this.props.onHide}>Cancel</Button>
          <Button bsStyle="primary" disabled={this.state.isSyncing} onClick={this.sync}>Sync</Button>
        </Modal.Footer>
      </Modal>
    )
  }
